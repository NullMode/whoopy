    ...
    async def test_get_cycle_by_id(self, client):
        ...
        async with client as whoop:
            with aioresponses() as m:
                ...
                m.get(
                    "https://api.prod.whoop.com/developer/v2/cycle/12345",
                    payload=cycle_data
                )
    ...
    async def test_get_cycle_collection(self, client):
        ...
        async with client as whoop:
            with aioresponses() as m:
                ...
                m.get(
                    "https://api.prod.whoop.com/developer/v2/cycle?limit=25&nextToken=token123",
                    payload=page2_data
                )
    ...
    async def test_get_sleep_for_cycle(self, client):
        ...
        async with client as whoop:
            with aioresponses() as m:
                ...
                m.get(
                    "https://api.prod.whoop.com/developer/v2/cycle/12345/sleep",
                    payload=sleep_data
                )
    ...
    async def test_get_sleep_by_id(self, client):
        ...
        async with client as whoop:
            with aioresponses() as m:
                ...
                m.get(
                    f"https://api.prod.whoop.com/developer/v2/activity/sleep/{sleep_id}",
                    payload=sleep_data
                )
    ...
    async def test_get_workout_by_id(self, client):
        ...
        async with client as whoop:
            with aioresponses() as m:
                ...
                m.get(
                    f"https://api.prod.whoop.com/developer/v2/activity/workout/{workout_id}",
